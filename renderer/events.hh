...
using Event = std::variant<KeyEvent, MouseMoveEvent, LeftButtonMouseEvent,
                           RightButtonMouseEvent>;
...
private:
  ...
  std::unordered_map<EventState, std::vector<detail::EventWithMetadata>>
      handlers_;
